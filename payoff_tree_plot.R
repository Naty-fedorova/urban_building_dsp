...
# legend
arrows(x0 = -1, y0=1, x1=0.5, y1=3, length = 0.03, lty = 2)
arrows(-1, 1, 0.5, 0, length = 0.03, lty = 1)
text(x = 0.5, y = 3, "0: no have", cex = cex , pos = 4)
text(x = 0.5, y = 0, "1: have", cex = cex , pos = 4)
}
